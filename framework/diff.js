...
function normalizeChildren(children) {
  ...
  return children.filter((child) => child !== false && child !== null && child !== undefined);
}
...
export function diffAndUpdate(parent, oldVirtualTree, newVirtualTree) {
  if (!oldVirtualTree) {
    ...
    if (
      newVirtualTree.type === "div" &&
      newVirtualTree.props &&
      newVirtualTree.props.children &&
      oldVirtualTree.type === "div" &&
      oldVirtualTree.props &&
      oldVirtualTree.props.children
    ) {
